package com.hongyan.smartrefresh.layout;
...
import com.hongyan.smartrefresh.layout.api.DefaultRefreshFooterCreator;
import com.hongyan.smartrefresh.layout.api.DefaultRefreshHeaderCreator;
import com.hongyan.smartrefresh.layout.api.RefreshContent;
import com.hongyan.smartrefresh.layout.api.RefreshFooter;
import com.hongyan.smartrefresh.layout.api.RefreshHeader;
import com.hongyan.smartrefresh.layout.api.RefreshInternal;
import com.hongyan.smartrefresh.layout.api.RefreshKernel;
import com.hongyan.smartrefresh.layout.api.RefreshLayout;
import com.hongyan.smartrefresh.layout.api.ScrollBoundaryDecider;
import com.hongyan.smartrefresh.layout.constant.DimensionStatus;
import com.hongyan.smartrefresh.layout.constant.RefreshState;
import com.hongyan.smartrefresh.layout.constant.SpinnerStyle;
import com.hongyan.smartrefresh.layout.footer.BallPulseFooter;
import com.hongyan.smartrefresh.layout.header.BezierRadarHeader;
import com.hongyan.smartrefresh.layout.impl.RefreshContentWrapper;
import com.hongyan.smartrefresh.layout.impl.RefreshFooterWrapper;
import com.hongyan.smartrefresh.layout.impl.RefreshHeaderWrapper;
import com.hongyan.smartrefresh.layout.listener.OnLoadMoreListener;
import com.hongyan.smartrefresh.layout.listener.OnMultiPurposeListener;
import com.hongyan.smartrefresh.layout.listener.OnRefreshListener;
import com.hongyan.smartrefresh.layout.listener.OnRefreshLoadMoreListener;
import com.hongyan.smartrefresh.layout.listener.OnStateChangedListener;
import com.hongyan.smartrefresh.layout.util.DelayedRunnable;
import com.hongyan.smartrefresh.layout.util.DensityUtil;
import com.hongyan.smartrefresh.layout.util.ScrollBoundaryUtil;
import com.hongyan.smartrefresh.layout.util.ViscousFluidInterpolator;
...
import static com.hongyan.smartrefresh.layout.util.DensityUtil.dp2px;
import static com.hongyan.smartrefresh.layout.util.SmartUtil.fling;
import static com.hongyan.smartrefresh.layout.util.SmartUtil.getColor;
import static com.hongyan.smartrefresh.layout.util.SmartUtil.isScrollableView;
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.hongyan.smartrefresh.layout.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.hongyan.smartrefresh.layout.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
