...
public class Failed1Fragment extends BaseFragment implements EventListModel.UIRequestListener {

    private View view;
    private PullToRefreshListView listView;
    private Failed1Fragment.FailedAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view == null) {
            ...
            adapter = new Failed1Fragment.FailedAdapter();
