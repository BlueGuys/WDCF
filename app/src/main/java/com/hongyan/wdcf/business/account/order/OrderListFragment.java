...
public class OrderListFragment extends BaseFragment implements OrderListModel.UIRequestListener {

    private View view;
    private PullToRefreshListView listView;
    private OrderListFragment.OrderSubscribeAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view == null) {
            ...
            adapter = new OrderListFragment.OrderSubscribeAdapter();
    ...
    class OrderSubscribeAdapter extends BaseAdapter {
