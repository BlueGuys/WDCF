...
public class StudyHolder extends BaseViewHolder implements IViewHolder, View.OnClickListener {

    private StudyAdapter adapter;
    private PullToRefreshListView listView;
    private Button button;

    public StudyHolder(BaseActivity mActivity) {
        super(mActivity);
    }
    ...
    public void initView(View rootView) {
        ...
        adapter = new StudyAdapter(mActivity);
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                StudyResult.Customer customer = adapter.getItem(position - 1);
    ...
    public RequestBean getRequestBean() {
        RequestBean bean = new RequestBean<>(StudyResult.class);
    ...
    public <T extends BaseResult> void onRequestSuccess(T result) {
        StudyResult customerListResult = (StudyResult) result;
    ...
    protected void setDataList(ArrayList<StudyResult.Customer> list) {
