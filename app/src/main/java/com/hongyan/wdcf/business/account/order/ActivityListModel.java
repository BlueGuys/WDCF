...
public class ActivityListModel extends BaseModel {
    ...
    public ActivityListModel(UIRequestListener listener) {
        this.mListener = listener;
    }

    public void refresh() {
        WDNetworkCall orderListCall = new WDNetworkCall<>();
        orderListCall.setRequestUrl(UrlConst.getMyActivityListUrl());
        orderListCall.addParam(RequestKeyTable.PAGE, "1");
