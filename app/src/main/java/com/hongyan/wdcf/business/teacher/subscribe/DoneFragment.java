...
public class DoneFragment extends BaseFragment implements OrderListModel.UIRequestListener{

    private View view;
    private PullToRefreshListView listView;
    private DoneFragment.DoneAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view == null) {
            ...
            adapter = new DoneFragment.DoneAdapter();
