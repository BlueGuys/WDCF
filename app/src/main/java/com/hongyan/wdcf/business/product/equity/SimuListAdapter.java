...
public class SimuListAdapter extends BaseAdapter {


    private ArrayList<SimuListResult.Product> mList = new ArrayList<>();
    private Context mContext;

    public SimuListAdapter(Context context) {
        this.mContext = context;
    }

    public void setData(ArrayList<SimuListResult.Product> list) {
        if (list != null) {
            mList.addAll(list);
        }
